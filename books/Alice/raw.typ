#box(image("lastorialist/AAIW_F.gif"))
...
There was nothing so #emph[very] remarkable in that; nor did Alice think
it so #emph[very] much out of the way to hear the Rabbit say to itself,
...
Down, down, down. Would the fall #emph[never] come to an end? "I wonder
...
this was not a #emph[very] good opportunity for showing off her
...
#emph[through] the earth! How funny it'll seem to come out among the
people that walk with their heads downward! The Antipathies, I think---"
(she was rather glad there #emph[was] no one listening, this time, as it
...
#emph[curtseying] as you're falling through the air! Do you think you
...
not going to do #emph[that] in a hurry. "No, I'll look first," she said,
"and see whether it's marked '#emph[poison]' or not"; for she had read
several nice little histories about children who had got burnt, and
eaten up by wild beasts and other unpleasant things, all because they
#emph[would] not remember the simple rules their friends had taught
them: such as, that a red-hot poker will burn you if you hold it too
long; and that if you cut your finger #emph[very] deeply with a knife,
it usually bleeds; and she had never forgotten that, if you drink much
from a bottle marked "poison," it is almost certain to disagree with
you, sooner or later.

However, this bottle was #emph[not] marked "poison," so Alice ventured
...
Why, there's hardly enough of me left to make #emph[one] respectable
person!"
...
#emph[I] shan't be able! I shall be a great deal too far off to trouble
...
#emph[Alice's Right Foot, Esq., \ Hearthrug, near the Fender,] \
(#emph[with Alice's love]).
...
the world am I? Ah, #emph[that's] the great puzzle!" And she began
...
very little! Besides, #emph[she's] she, and #emph[I'm] I, and---oh dear,
how puzzling it all is! I'll try if I know all the things I used to
know. Let me see: four times five is twelve, and four times six is
...
of Rome, and Rome---no, #emph[that's] all wrong, I'm certain! I must
have been changed for Mabel! I'll try and say '#emph[How doth the
...
pour the waters of the Nile \ ~~~~On every golden scale! \ \ "How
...
burst of tears, "I do wish they #emph[would] put their heads down! I am
so #emph[very] tired of being all alone here!"

As she said this she looked down at her hands, and was surprised to see
that she had put on one of the Rabbit's little white kid gloves while
she was talking. "How #emph[can] I have done that?" she thought. "I must
...
"That #emph[was] a narrow escape!" said Alice, a good deal frightened at
...
being drowned in my own tears! That #emph[will] be a queer thing, to be
...
#emph[you] like cats if you were me?"
...
tail. "As if #emph[I] would talk on such a subject! Our family always
#emph[hated] cats: nasty, low, vulgar things! Don't let me hear the name
again!"
...
"Found #emph[it]," the Mouse replied rather crossly: "of course you know
what 'it' means."
...
"What #emph[is] a Caucus-race?" said Alice; not that she wanted much to
know, but the Dodo had paused as if it thought that #emph[somebody]
...
"Why, #emph[she], of course," said the Dodo, pointing to Alice with one
...
"It #emph[is] a long tail, certainly," said Alice, looking down with
...
us both \ ~~~~~go to law: \ ~~~#emph[I] will \ ~~prosecute \
#emph[you]\.---Come, \ ~~I'll take \ ~~~~no denial; \ ~~~~~~~We must \
~~~~~~~~have a \ ~~~~~~~~~trial: \ ~~~~~~~~For really \ ~~~~~this
morning \ ~~~~I've nothing \ ~~to do.' \ ~~~~Said the \ ~~~~~~~mouse \
~~~~~~~to the \ ~~~~~~~~~cur, \ ~~~~~~~~'Such a \ ~~~~~~~~~~trial, \
~~~~~~~dear sir, \ ~~~~~With no \ ~~jury or \ judge, \ ~~would be \
~~~~~wasting \ ~~~~~our breath.' \ ~~~~~~~'I'll be \ ~~~~~~judge, I'll \
~~~~be jury,' \ ~~~~~Said \ ~~~~~~~cunning \ ~~~~~~~~~old Fury: \
...
ferrets! Where #emph[can] I have dropped them, I wonder?" Alice guessed
...
called out to her in an angry tone, "Why, Mary Ann, what #emph[are] you
...
to her lips. "I know #emph[something] interesting is sure to happen,"
...
can do no more, whatever happens. What #emph[will] become of me?"
...
"But then," thought Alice, "shall I #emph[never] get any older than I am
now? That'll be a comfort, one way---never to be an old woman---but
then---always to have lessons to learn! Oh, I shouldn't like
#emph[that!]"

"Oh, you foolish Alice!" she answered herself. "How can you learn
lessons in here? Why, there's hardly room for #emph[you], and no room at
...
"#emph[That] you won't!" thought Alice, and, after waiting till she
...
#emph[could!] I'm sure #emph[I] don't want to stay in here any longer!"
...
"A barrowful of #emph[what?]" thought Alice; but she had not long to
...
I've got to grow up again! Let me see---how #emph[is] it to be managed?
...
"Who are #emph[you?]" said the Caterpillar.

This was not an encouraging opening for a conversation. Alice replied,
rather shyly, "I---I hardly know, sir, just at present---at least I know
who I #emph[was] when I got up this morning, but I think I must have
been changed several times since then."

"What do you mean by that?" said the Caterpillar sternly. "Explain
yourself!"

"I can't explain #emph[myself], I'm afraid, sir," said Alice, "because
...
is, it would feel very queer to #emph[me]\."

"You!" said the Caterpillar contemptuously. "Who are #emph[you?]"

Which brought them back again to the beginning of the conversation.
Alice felt a little irritated at the Caterpillar's making such
#emph[very] short remarks, and she drew herself up and said, very
gravely, "I think, you ought to tell me who #emph[you] are, first."

"Why?" said the Caterpillar.

Here was another puzzling question; and as Alice could not think of any
good reason, and as the Caterpillar seemed to be in a #emph[very]
...
"Can't remember #emph[what] things?" said the Caterpillar.

"Well, I've tried to say "How doth the little busy bee," but it all came
different!" Alice replied in a very melancholy voice.

"Repeat, '#emph[You are old, Father William],'" said the Caterpillar.
...
~~~~Do you think, at your age, it is right?" \ \ "In my youth," Father
William replied to his son, \ ~~~~"I feared it might injure the brain; \
But, now that I'm perfectly sure I have none, \ ~~~~Why, I do it again
and again." \ \ "You are old," said the youth, "as I mentioned before, \
~~~~And have grown most uncommonly fat; \ Yet you turned a
back-somersault in at the door--- \ ~~~~Pray, what is the reason of
that?" \ \ "In my youth," said the sage, as he shook his grey locks, \
~~~~"I kept all my limbs very supple \ By the use of this ointment---one
shilling the box--- \ ~~~~Allow me to sell you a couple?" \ \ "You are
old," said the youth, "and your jaws are too weak \ ~~~~For anything
tougher than suet; \ Yet you finished the goose, with the bones and the
beak--- \ ~~~~Pray, how did you manage to do it?" \ \ "In my youth,"
said his father, "I took to the law, \ ~~~~And argued each case with my
wife; \ And the muscular strength, which it gave to my jaw, \ ~~~~Has
lasted the rest of my life." \ \ "You are old," said the youth, "one
would hardly suppose \ ~~~~That your eye was as steady as ever; \ Yet
you balanced an eel on the end of your nose--- \ ~~~~What made you so
awfully clever?" \ \ "I have answered three questions, and that is
enough," \ ~~~~Said his father; "don't give yourself airs! \ Do you
think I can listen all day to such stuff? \ ~~~~Be off, or I'll kick you
down stairs!"

"That is not said right," said the Caterpillar.

"Not #emph[quite] right, I'm afraid," said Alice, timidly; "some of the
...
"I #emph[don't] know," said the Caterpillar.
...
"Well, I should like to be a #emph[little] larger, sir, if you wouldn't
...
"One side of #emph[what?] The other side of #emph[what?]" thought Alice
to herself.
...
"What #emph[can] all that green stuff be?" said Alice. "And where
#emph[have] my shoulders got to? And oh, my poor hands, how is it I
...
"I'm #emph[not] a serpent!" said Alice indignantly. "Let me alone!"
...
"But I'm #emph[not] a serpent, I tell you!" said Alice. "I'm a---I'm
a---"

"Well! #emph[What] are you?" said the Pigeon. "I can see you're trying
to invent something!"
...
#emph[one] with such a neck as that! No, no! You're a serpent; and
there's no use denying it. I suppose you'll be telling me next that you
never tasted an egg!"

"I #emph[have] tasted eggs, certainly," said Alice, who was a very
...
looking for eggs, I know #emph[that] well enough; and what does it
matter to me whether you're a little girl or a serpent?"

"It matters a good deal to #emph[me]," said Alice hastily; "but I'm not
looking for eggs, as it happens; and if I was, I shouldn't want
#emph[yours]: I don't like them raw."
...
#emph[is] that to be done, I wonder?" As she said this, she came
...
them #emph[this] size: why, I should frighten them out of their wits!"
...
if you were #emph[inside], you might knock, and I could let you out, you
...
she said to herself; "his eyes are so #emph[very] nearly at the top of
his head. But at any rate he might answer questions.---How am I to get
...
"But what am #emph[I] to do?" said Alice.
...
"Oh, #emph[please] mind what you're doing!" cried Alice, jumping up and
down in an agony of terror. "Oh, there goes his #emph[precious] nose!"
as an unusually large saucepan flew close by it, and very nearly carried
it off.

"If everybody minded their own business," the Duchess said in a hoarse
growl, "the world would go round a deal faster than it does."

"Which would #emph[not] be an advantage," said Alice, who felt very glad
...
be #emph[no] mistake about it: it was neither more nor less than a pig,
...
"---so long as I get #emph[somewhere]," Alice added as an explanation.
...
"#emph[I] call it purring, not growling," said Alice.
...
coming. "There's #emph[plenty] of room!" said Alice indignantly, and she
...
"I didn't know it was #emph[your] table," said Alice; "it's laid for a
...
#emph[said] was, "Why is a raven like a writing-desk?"
...
"It #emph[is] the same thing with you," said the Hatter, and here the
...
"It was the #emph[best] butter," the March Hare meekly replied.
...
nothing better to say than his first remark, "It was the #emph[best]
butter, you know."
...
"Why should it?" muttered the Hatter. "Does #emph[your] watch tell you
what year it is?"

"Of course not," Alice replied very readily: "but that's because it
stays the same year for such a long time together."

"Which is just the case with #emph[mine]," said the Hatter.
...
about wasting #emph[it]. It's #emph[him]\."
...
"Is that the way #emph[you] manage?" Alice asked.

The Hatter shook his head mournfully. "Not I!" he replied. "We
quarrelled last March---just before #emph[he] went mad, you know---"
...
"#emph[Twinkle, twinkle, twinkle, twinkle]---" and went on so long that
...
"So they were," said the Dormouse; "#emph[very] ill."
...
"You mean you can't take #emph[less]," said the Hatter: "it's very easy
to take #emph[more] than nothing."

"Nobody asked #emph[your] opinion," said Alice.
...
dare say there may be #emph[one]\."
...
"But they were #emph[in] the well," Alice said to the Dormouse, not
...
"At any rate I'll never go #emph[there] again!" said Alice as she picked
...
then she walked down the little passage: and #emph[then]---she found
...
"How should #emph[I] know?" said Alice, surprised at her own courage.
"It's no business of #emph[mine]\."
...
blow with its head, it #emph[would] twist itself round and look up in
...
"Who #emph[are] you talking to?" said the King, going up to Alice, and
...
"When #emph[I'm] a Duchess," she said to herself, (not in a very hopeful
tone though), "I won't have any pepper in my kitchen #emph[at all]. Soup
...
children sweet-tempered. I only wish people knew #emph[that]: then they
...
Duchess was #emph[very] ugly; and secondly, because she was exactly the
...
#emph[that] is---'Take care of the sense, and the sounds will take care
of themselves.'"
...
"It's a mineral, I #emph[think]," said Alice.
...
the company generally, "You are all pardoned." "Come, #emph[that's] a
...
"What #emph[is] the fun?" said Alice.

"Why, #emph[she]," said the Gryphon. "It's all her fancy, that: they
...
herself, "I don't see how he can #emph[ever] finish, if he doesn't
...
help thinking there #emph[must] be more to come, so she sat still and
said nothing.
...
"#emph[I've] been to a day-school, too," said Alice; "you needn't be so
proud as all that."
...
tone of great relief. "Now at #emph[ours] they had at the end of the
bill, 'French, music, #emph[and washing]---extra.'"
...
that used to come once a week: #emph[he] taught us Drawling, Stretching,
and Fainting in Coils."

"What was #emph[that] like?" said Alice.

"Well, I can't show it you myself," the Mock Turtle said: "I'm too
stiff. And the Gryphon never learnt it."

"Hadn't time," said the Gryphon: "I went to the Classics master, though.
He was an old crab, #emph[he] was."
...
"#emph[It does the boots and shoes]," the Gryphon replied very solemnly.
...
their eyes and mouths so #emph[very] wide, but she gained courage as she
went on. Her listeners were perfectly quiet till she got to the part
about her repeating "#emph[You are old, Father William]," to the
...
The Panther took pie-crust, and gravy, and meat, \ While the Owl had the
dish as its share of the treat. \ When the pie was all finished, the
Owl, as a boon, \ Was kindly permitted to pocket the spoon: \ While the
Panther received knife and fork with a growl, \ And concluded the
banquet---\]
...
"Hm! No accounting for tastes! Sing her '#emph[Turtle Soup],' will you,
old fellow?"
...
pennyworth only of beautiful Soup? \ Pennyworth only of beautiful Soup?
...
could #emph[not] stand, and she went round the court and got behind him,
...
got much evidence #emph[yet]," she said to herself. Imagine her
...
"Oh, I #emph[beg] your pardon!" she exclaimed in a tone of great dismay,
...
to herself; "I should think it would be #emph[quite] as much use in the
...
"Nothing #emph[whatever?]" persisted the King.
...
Forty-two. #emph[All persons more than a mile high to leave the
court]\."

Everybody looked at Alice.

"#emph[I'm] not a mile high," said Alice.
...
gave me a good character, \ ~~~~But said I could not swim. \ \ He sent
them word I had not gone \ ~~~~(We know it to be true): \ If she should
push the matter on, \ ~~~~What would become of you? \ \ I gave her one,
they gave him two, \ ~~~~You gave us three or more; \ They all returned
from him to you, \ ~~~~Though they were mine before. \ \ If I or she
should chance to be \ ~~~~Involved in this affair, \ He trusts to you to
set them free, \ ~~~~Exactly as we were. \ \ My notion was that you had
been \ ~~~~(Before she had this fit) \ An obstacle that came between \
~~~~Him, and ourselves, and it. \ \ Don't let him know she liked them
best, \ ~~~~For this must ever be \ A secret, kept from all the rest, \
...
him,) "I'll give him sixpence. #emph[I] don't believe there's an atom of
meaning in it."

The jury all wrote down on their slates, "#emph[She] doesn't believe
...
"---#emph[said I could not swim]---" you can't swim, can you?" he added,
...
of course---'#emph[I gave her one, they gave him two]---' why, that must
be what he did with the tarts, you know---"

"But, it goes on '#emph[they all returned from him to you],'" said
Alice.

"Why, there they are!" said the King triumphantly, pointing to the tarts
on the table. "Nothing can be clearer than #emph[that]. Then
again---'#emph[before she had this fit]---' you never had fits, my dear,
...
finished, her sister kissed her, and said, "It #emph[was] a curious
...
#emph[would] always get into her eyes---and still as she listened, or
...
make #emph[their] eyes bright and eager with many a strange tale,
